...
COMMENT ON TABLE public.ml_predictions IS 'Table to store prediction value from telep_model_server';
...
COMMENT ON COLUMN public.ml_predictions.feature_hash IS 'SHA256 of the input features (including care_request_id)';
...
COMMENT ON COLUMN public.ml_predictions.prediction IS 'Final Tele-p model prediction';
...
COMMENT ON COLUMN public.ml_predictions.model_version IS 'Hybrid model version';
