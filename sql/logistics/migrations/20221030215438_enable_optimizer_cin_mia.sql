...
SELECT
    default_settings.service_region_id,
    default_settings.optimizer_enabled,
    ...
    (
        ...
        LIMIT
            1
    ) AS optimizer_config_id,
    default_settings.is_default,
