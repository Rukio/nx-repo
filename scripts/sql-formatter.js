...
// Forked from https://github.com/zeroturnaround/sql-formatter/blob/master/bin/sqlfmt.js
// TODO: Remove once fixes are merged for extraneous newlines and diffing:
// https://github.com/zeroturnaround/sql-formatter/pull/194
// https://github.com/zeroturnaround/sql-formatter/pull/195
...
const {
  format,
  supportedDialects,
} = require('../node_modules/sql-formatter/lib/sqlFormatter');
const fs = require('fs');
...
function getArgs() {
  ...
  parser.add_argument('--check-diff', {
    help: 'Checks if the output would differ from the input. Returns non-zero exit code if there is a difference.',
    action: 'store_true',
    default: false,
  });
