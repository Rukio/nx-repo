...
func (s *Server) SearchPartners(ctx context.Context, req *partnerpb.SearchPartnersRequest) (*partnerpb.SearchPartnersResponse, error) {
	...
	if len(partners) == 0 {
		return &partnerpb.SearchPartnersResponse{
