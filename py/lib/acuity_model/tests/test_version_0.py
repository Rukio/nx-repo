...
from acuity_model import version_0
...
test_data = [
    ...
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_ALLERGIC_REACTION, acuity_proto.ACUITY_HIGH),
    ...
    (-1, 65, risk_strat_proto.RISK_PROTOCOL_V1_DIFFICULTY_URINATING, acuity_proto.ACUITY_MEDIUM),
    (65, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_DIFFICULTY_URINATING, acuity_proto.ACUITY_HIGH),
    (-1, 45, risk_strat_proto.RISK_PROTOCOL_V1_DIZZINESS, acuity_proto.ACUITY_MEDIUM),
    (45, 65, risk_strat_proto.RISK_PROTOCOL_V1_DIZZINESS, acuity_proto.ACUITY_HIGH),
    ...
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_EPISTAXIS, acuity_proto.ACUITY_HIGH),
    (-1, 65, risk_strat_proto.RISK_PROTOCOL_V1_EXTREMITY_INJURY_OR_PAIN, acuity_proto.ACUITY_LOW),
    (65, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_EXTREMITY_INJURY_OR_PAIN, acuity_proto.ACUITY_HIGH),
    (65, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_EXTREMITY_INJURY_OR_PAIN, acuity_proto.ACUITY_HIGH),
    (-1, 65, risk_strat_proto.RISK_PROTOCOL_V1_EXTREMITY_SWELLING, acuity_proto.ACUITY_MEDIUM),
    (65, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_EXTREMITY_SWELLING, acuity_proto.ACUITY_HIGH),
    (-1, 65, risk_strat_proto.RISK_PROTOCOL_V1_FALL_WITHOUT_INJURY, acuity_proto.ACUITY_MEDIUM),
    (65, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_FALL_WITHOUT_INJURY, acuity_proto.ACUITY_HIGH),
    # NOTE: aggregated all of fever+chills, as its all high acuity
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_FEVER, acuity_proto.ACUITY_HIGH),
    ...
    (-1, 65, risk_strat_proto.RISK_PROTOCOL_V1_HYPERTENSION, acuity_proto.ACUITY_MEDIUM),
    (65, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_HYPERTENSION, acuity_proto.ACUITY_HIGH),
    ...
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_POST_ACUTE_PATIENT_FOLLOW_UP, acuity_proto.ACUITY_LOW),
    (-1, 65, risk_strat_proto.RISK_PROTOCOL_V1_RECTAL_PAIN, acuity_proto.ACUITY_LOW),
    (65, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_RECTAL_PAIN, acuity_proto.ACUITY_HIGH),
    ...
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_TESTICULAR_PAIN, acuity_proto.ACUITY_HIGH),
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_UNABLE_TO_URINATE, acuity_proto.ACUITY_HIGH),
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_VISION_PROBLEM, acuity_proto.ACUITY_MEDIUM),
    ...
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_PULSE_HEART, acuity_proto.ACUITY_MEDIUM),
    ...
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_PROVIDER_REQUESTED, acuity_proto.ACUITY_LOW),
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_EMS_ET3_TREAT_IN_PLACE, acuity_proto.ACUITY_LOW),
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_ADVANCED_CARE, acuity_proto.ACUITY_MEDIUM),
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_NECK_PAIN, acuity_proto.ACUITY_MEDIUM),
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_EMERGENCY_DEPARTMENT_TO_HOME, acuity_proto.ACUITY_LOW),
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_REGISTERED_NURSE, acuity_proto.ACUITY_LOW),
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_UNSPECIFIED, acuity_proto.ACUITY_LOW),
    (-1, 65, risk_strat_proto.RISK_PROTOCOL_V1_NAUSEA_OR_VOMITING_OR_DIARRHEA, acuity_proto.ACUITY_MEDIUM),
    (65, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_NAUSEA_OR_VOMITING_OR_DIARRHEA, acuity_proto.ACUITY_HIGH),
    (-1, 45, risk_strat_proto.RISK_PROTOCOL_V1_ABDOMINAL_PAIN_OR_CONSTIPATION, acuity_proto.ACUITY_MEDIUM),
    (45, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_ABDOMINAL_PAIN_OR_CONSTIPATION, acuity_proto.ACUITY_HIGH),
    ...
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_DH_PROVIDER_RISK_STRATIFICATION, acuity_proto.ACUITY_LOW),
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_COVID19_FACILITY_TESTING, acuity_proto.ACUITY_LOW),
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_OPTUM_SKILLED_NURSING_FACILITIES_ONBOARDING_PROCESS, acuity_proto.ACUITY_LOW),
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_PARTNER_USING_NATIONALLY_ACCREDITED_RISK_STRAT_PROCESS, acuity_proto.ACUITY_LOW),
...
test_data_override = [
    ...
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_ALLERGIC_REACTION, other_override_reason, acuity_proto.ACUITY_HIGH),
...
test_data_risk_strat_bypass = [
    ...
    (-1, 45, risk_strat_proto.RISK_PROTOCOL_V1_ABDOMINAL_PAIN, True, acuity_proto.ACUITY_HIGH),
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_ANIMAL_BITE, False, acuity_proto.ACUITY_LOW),
    (-1, utils.OLD_AGE, risk_strat_proto.RISK_PROTOCOL_V1_ANIMAL_BITE, True, acuity_proto.ACUITY_HIGH),
]


def test_validate_request_invalid_age():
    model = version_0.V0(logger=Mock(), statsd=Mock())
